...
# TODO: Replace <FILL IN> with appropriate code
#or wordCountsGrouped = wordsGrouped.mapValues(lambda x: sum(x))
...
# TODO: Replace <FILL IN> with appropriate code
myworldscount=sc.parallelize(wordCountsCollected)
uniqueWords = myworldscount.map(lambda x: 1).reduce(lambda a,b:a+b)
...
# TODO: Replace <FILL IN> with appropriate code
#tsa tsia. an itan keno to x girnaei false
...
#gia na sortarei me to deytero key
